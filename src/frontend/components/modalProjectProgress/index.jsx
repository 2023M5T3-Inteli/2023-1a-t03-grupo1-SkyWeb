...
export function ResponsiveDialogProgress() {
                ...
                <DialogContent sx={{ backgroundColor: "cardBackground" }} >
                    <DialogContentText >
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Typography variant='title3' style={{marginLeft:"10px" }}>Aplicattions </Typography>
                            <Grid item lg={12}>
                            ...
                            <Typography variant='title3' style={{ marginLeft: "10px" }}>Team </Typography>
                            <Grid item lg={12}>
                                <Paper style={{ width: "100%", height: "300px", overflowY: "scroll" }} >
                                    <Grid container spacing={2}>
                                        <Grid item lg={3}>
